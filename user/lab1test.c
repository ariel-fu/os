...
int main() {
  ...
  // while (1);
  printf(stdout,"at testing open\n");
  testopen();
  printf(stdout,"at testing invalid args\n");
  testinvalidargs();
  printf(stdout,"at testing file read\n");
  smallfilereadtest();
  printf(stdout,"at testing no files\n");
  nofilestest();
  printf(stdout,"at testing dup\n");
  duptest();
